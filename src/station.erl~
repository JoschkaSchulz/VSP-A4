...
%% Startmethode des Listeners, �ffnet das UDP-Socket
...
%% ====================================================================
%%	Beispiel: Wie erkennen wir den n�chsten Frame?
%% 
...
%% 			%%Datensenke speichere die Nachricht
			...
			% Wurde das Paket im n�chsten Frame gesendet?
			...
			false ->
				...
				% ggf. neuen Slot w�hlen (zum Reservieren)
				case ReservedSlot == Slot of
					true ->
						% suche den Slot zuf�llig aus
...
%% Startmethode des Senders, �ffnet das UDP-Socket
...
%% ====================================================================
%% Beispiel: Wie viele Millisekunden sind es bis zum n�chsten Frame?
%% 
...
%%	Nutzdaten(2)  	=>	Byte 10-23: Reserviert f�r weitere Nutzdaten
%%	Stationsklasse 	=>	Byte 24: Stationsklasse (A oder B)
%%	SlotNummer		=>	Byte 25: Nummer des Slots, in dem die Station im n�chsten Frame senden wird
...
% Setzt die Liste der freien Slots auf seinen Standard zur�ck
